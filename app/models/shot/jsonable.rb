class Shot
  module Jsonable
    ...
    def decent_json(with_data)
      ...
      json.merge(visualizer_attributes.slice(*%i[start_time user_name metadata tags profile_url image_url roaster_id coffee_bag_id]))
    end
    ...
    def visualizer_attributes
      ...
      attributes[:metadata] = metadata.presence
      attributes[:tags] = tags.pluck(:name)
      ...
      attributes[:roaster_id] = coffee_bag&.roaster&.id
      attributes[:coffee_bag_id] = coffee_bag&.id
