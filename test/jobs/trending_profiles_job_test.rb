...
class TrendingProfilesJobTest < ActiveJob::TestCase
  test "writes trending stats to cache" do
    ...
    public_shot = create(:shot, public: true, profile_title: "Sweet Bloom", start_time: recent_time, espresso_enjoyment: 84, bean_weight: 18, drink_weight: 54)
    ...
    assert_equal [{name: "Sweet Bloom", count: 1, avg_enjoyment: 84, avg_ratio: 3.0}], trending[:profiles]
