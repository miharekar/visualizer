...
module Parsers
  class SepCsvTest < ActiveSupport::TestCase
    setup do
    ...
    test "smart espresso profiler file" do
      ...
      assert_in_delta(0.051, shot.information.timeframe.first)
      assert_in_delta(48.403, shot.information.timeframe.last)
      assert_in_delta(48.403, shot.duration)
    ...
    test "extracts pressure from CoffeeFlow app" do
      ...
      assert_in_delta(0.336, shot.information.timeframe.first)
      assert_in_delta(58.536, shot.information.timeframe.last)
      assert_in_delta(58.536, shot.duration)
      assert_equal %w[espresso_flow_weight espresso_pressure espresso_weight], shot.information.data.keys.sort
      assert_in_delta(4.660000000000004, shot.information.data["espresso_weight"][400])
      assert_in_delta(8.727121090778084, shot.information.data["espresso_pressure"][400])
    ...
    test "extracts temperature from Pressensor" do
      ...
      assert_in_delta(0.033, shot.information.timeframe.first)
      assert_in_delta(33.082, shot.information.timeframe.last)
      assert_in_delta(33.082, shot.duration)
      ...
      assert_in_delta(27.29, shot.information.data["espresso_weight"][400])
      assert_in_delta(1.488175344887875, shot.information.data["espresso_pressure"][400])
    ...
    test "extracts correct length from Pressensor" do
      ...
      assert_in_delta(0.028, shot.information.timeframe.first)
      assert_in_delta(18.638, shot.information.timeframe.last.round(3))
      assert_in_delta(18.638, shot.duration.round(3))
      assert_equal %w[espresso_flow_weight espresso_pressure espresso_temperature_mix espresso_weight], shot.information.data.keys.sort
      assert_in_delta(36.06, shot.information.data["espresso_weight"][150])
      assert_in_delta(1.771564746242297, shot.information.data["espresso_pressure"][150])
      assert_in_delta(1.45, shot.information.data["espresso_flow_weight"][50])
